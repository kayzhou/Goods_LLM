...
class Config:
    ...
    model_path = "/home/llm/liguanqun/model/bert-base-chinese"
    checkpoint_path = "/home/llm/liguanqun/model/bert-base-chinese/checkpoints/"
    result_file = "/home/llm/liguanqun/毕设new/代码/bert/results.csv"
    max_len = 64
    batch_size = 16
    epochs = 5
...
def main():
    ...
    # 将整个程序运行的总时间记录到文件中
    with open("/home/llm/liguanqun/毕设new/代码/bert/time.txt", "a") as f:
