...
X_w2v = torch.tensor([torch.tensor(sent).mean(dim=0).numpy() for sent in X_w2v], dtype=torch.float32)
print(X_w2v)
print(X_w2v.shape)
...
results_df.to_csv('/home/llm/liguanqun/毕设new/代码/cnn/wv-evaluation_results.csv', index=False)
