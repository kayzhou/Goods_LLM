...
def main():
    ...
    # train_output_file = "/home/llm/liguanqun/案例大赛/data/蚂蚁商联多维标注对话_去除低频label_train.json"
    test_output_files = [f"/home/llm/liguanqun/案例大赛/data/蚂蚁商联多维标注对话new_去除低频label_test_{i + 1}.json" for i in range(5)]
